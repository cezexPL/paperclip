...
const priorityConfig: Record<string, { icon: typeof ArrowUp; color: string; labelKey: string }> = {
  critical: { icon: AlertTriangle, color: priorityColor.critical ?? priorityColorDefault, labelKey: "priority.critical" },
  high: { icon: ArrowUp, color: priorityColor.high ?? priorityColorDefault, labelKey: "priority.high" },
  medium: { icon: Minus, color: priorityColor.medium ?? priorityColorDefault, labelKey: "priority.medium" },
  low: { icon: ArrowDown, color: priorityColor.low ?? priorityColorDefault, labelKey: "priority.low" },
};
