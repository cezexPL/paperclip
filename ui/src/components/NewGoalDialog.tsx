...
const levelLabelKeys: Record<string, string> = {
  company: "goalProperties.company",
  team: "goalProperties.team",
  agent: "goalProperties.agent",
  task: "goalProperties.task",
};
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-2.5 border-b border-border">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{newGoalDefaults.parentId ? t("newGoalDialog.newSubGoal") : t("newGoalDialog.title")}</span>
          </div>
        ...
        <div className="flex items-center justify-end px-4 py-2.5 border-t border-border">
          ...
          >
            {createGoal.isPending ? t("onboarding.creating") : t("common.create")}
          </Button>
        </div>
      </DialogContent>
    </Dialog>
